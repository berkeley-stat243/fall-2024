...
If you weren't able to attend in person, then you can write on Ed so that I can
...
If you finish reading before your pair, you can take care of the exercises in
the [Pair exercises](#pair-exercises) section.
...
![The cycle of Git life.](lab9-git/lifecycle.png)
...
complete. Recall the meaning of stashing in the [git branch](#git-branch)
section above.

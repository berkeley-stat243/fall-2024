---
title: "SCF and Parallel Computing"
date: "2024-10-11"
format:
  pdf:
...
except when running threaded code. When setting up parallel python code, you can find
out how many cores there are on the node assigned to you with:

```python
import os
ncores = os.getenv("SLURM_CPUS_ON_NODE")
```
...
1. Call `sbatch submitBoot.sh` to execute the python script `boot_proc.py`.

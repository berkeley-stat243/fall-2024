...
[PDF](./unit6-parallel.pdf){.btn .btn-dark}
...
:::{.callout-tip title="Parallelization and operating systems"}
...
(**) It's fine to use the distributed scheduler on one machine, such as
...
Recall that in Unit 5, we [used JAX to run a vectorized calculation on a very large 1-d array](../unit5-programming.html#jit-compilation-with-jax).

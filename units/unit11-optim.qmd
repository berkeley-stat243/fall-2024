...
[PDF](./unit11-optim.pdf){.btn .btn-dark}
...
use of analytic or numerical derivatives of $f$ as well, or derivatives
from packages that provide automatic differentiation (AD).
...
4.  an understanding of the methods used in Python's optimization routines,
    their strengths and weaknesses, and various tricks for doing better
    optimization in Python, and
...
:::{.callout-warning title="Convergence of Newton's method"}
...
Stochastic gradient descent (SGD) is a well-known method in machine learning,
...
We saw an example of this in [Section 5](#newton-raphson-newtons-method-1).
...
:::{.callout-important title="Check your answer"}

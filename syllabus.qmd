...
SCF JupyterHub or the campus DataHub to access a bash shell or run an IPython notebook. (The campus DataHub is limited in terms of number of CPU cores and memory so won't be suitable for more computationally-intensive work later in the semester.)
...
sets,
 ...
 - 10% on your class participation:
    - discussions on Ed (i.e., responding to your classmates' questions and asking thoughtful questions about course material),
    - your responses to the in-class (and occasionally in-advance-of-class) Google forms questions, and
    - completion of occasional non-problem set assignments (including assignments in lab section).
